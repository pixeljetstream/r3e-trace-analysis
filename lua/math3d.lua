...
function _M.m4perspective(mat, fov, front,  back, aspect)
  ...
  mat[11] = -1.0;
  mat[14] = -2.0 * front * back / deltaZ;
  mat[15] = 0.0;
  return mat
end

function _M.m4orthoaspect(mat, height, front, back, aspect)
...
function _M.m4ortho(mat, left, right, bottom, top, front, back)
  _M.m4identity(mat);
  mat[0] = 2.0/(right-left);
  mat[5] = 2.0/(top-bottom);
  mat[10]= -2.0/(back-front);
